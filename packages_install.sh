if [ -f /etc/arch-release ]; then
  ...
  sudo pacman -S fish git hyprland wl-clipboard python3 npm btop foot waybar hyprpaper fuzzel unzip base-devel fd rofi-wayland dust duf jq libva-nvidia-driver inotify-tools dpkg firefox fcitx5-im fcitx5-gtk fcitx5-unikey fcitx5-qt kwindowsystem gdm zsh-syntax-highlighting bluez bluez-utils blueman pipewire pipewire-alsa pipewire-pulse pipewire-jack wireplumber sof-firmware fzf
